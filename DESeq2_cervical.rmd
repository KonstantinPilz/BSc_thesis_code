...
data_dir <- file.path(prefix, "data/bioinf/projects/data/2022_MLseq_KP/")
...
```{r}
file <- file.path(data_dir, "MLseq_original_data", "cervical.rda")
load(file = file)
...
file_rld <- file.path(result_dir, "01_rld.Rdata")
if (recompute) {
...
library("vsn")
library("hexbin")
jpeg(file = file.path(result_dir, "01_ntd.jpeg"))
