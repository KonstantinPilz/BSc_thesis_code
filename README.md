...
```
cd existing_repo
git remote add origin https://git.ufz.de/rnaseq/mlseq_evaluation.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.ufz.de/rnaseq/mlseq_evaluation/-/settings/integrations)
